...
class BookingManualTest extends ExtensionTest
{
   ...
   protected function handleEventPostFixtureRun()
   {
      ...
      $iRepeatWorkDayRule    = $oService->createRepeatingWorkDayRule($oDayWorkDayRuleStart,$oDayWorkDayRuleEnd,$iFiveMinuteTimeslot,$iNineAmSlot,$iFivePmSlot,'1-5','*','2-12','*','Repeat Workday Rule');
      ...
      $iSingleHolidayRule      = $oService->createSingleHolidayRule($oHolidayStart,$iFiveMinuteTimeslot,$iNineAmSlot,$iFivePmSlot, 'Single Holdiay Rule');             
   ...
   public function ConfictCheckerTest($iScheduleId,$oNow)
   {
       ...
       $sSql  ="";
       $sSql .=" UPDATE bolt_bm_schedule_slot SET is_override = false, is_available = true, is_excluded = true, booking_id = 1, is_closed = false " ;
       $sSql .=" WHERE schedule_id = ?  AND slot_open >= '2016-08-01 12:00:00' AND slot_close <= '2016-08-01 12:45:00'";
       
       $oDatabase->executeUpdate($sSql,[$iScheduleId],[Type::INTEGER]);
       
       
       // Conflict 2 Booking Schedule has been closed
       $sSql  ="";
       $sSql .=" UPDATE bolt_bm_schedule_slot SET is_override = false, is_available = true, is_excluded = false, booking_id = 1, is_closed = true " ;
