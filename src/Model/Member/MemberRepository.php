...
class MemberRepository extends ReadOnlyRepository implements ObjectRepository
{
    ...
    public function createQueryBuilder($alias = null)
    {
        ...
        $oQuery = new MemberQueryBuilder($this->getEntityManager()->getConnection(), $this);
    ...
    public function find($id)
    {
        ...
        $result = $qb->where($this->getAlias() . '.membership_id = :iMembershipId')
            ->setParameter('iMembershipId', $id)
            ->execute()
            ->fetch();
