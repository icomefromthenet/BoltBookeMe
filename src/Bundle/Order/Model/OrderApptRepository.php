...
class OrderApptRepository extends ReadOnlyRepository implements ObjectRepository
{
    ...
    public function createQueryBuilder($alias = null)
    {
        ...
        $oQuery = new OrderApptQueryBuilder($this->getEntityManager()->getConnection(), $this);
    ...
    public function find($id)
    {
        ...
        $result = $qb->where($this->getAlias() . '.appointment_id = :iAppointmentId')
            ->setParameter('iAppointmentId', $id)
            ->execute()
            ->fetch();
