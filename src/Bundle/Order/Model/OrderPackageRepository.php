...
class OrderPackageRepository extends ReadOnlyRepository implements ObjectRepository
{
    ...
    public function createQueryBuilder($alias = null)
    {
        ...
        $oQuery = new OrderPackageQueryBuilder($this->getEntityManager()->getConnection(), $this);
    ...
    public function find($id)
    {
        ...
        $result = $qb->where($this->getAlias() . '.package_id = :iPackageId')
            ->setParameter('iPackageId', $id)
            ->execute()
            ->fetch();
