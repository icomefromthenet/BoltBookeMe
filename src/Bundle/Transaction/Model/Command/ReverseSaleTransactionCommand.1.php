...
/**
 * This command is used to Reverse  a Sales Transaction 
 * 
 * @author Lewis Dyer <getintouch@icomefromthenet.com>
 * @since 1.0
 */ 
class ReverseSaleTransactionCommand  implements HasEventInterface
{
    ...
    {
        return BookMeEvents::SALE_TRANSACTION_REVERSED;  
    }
